...
class Blockchain(object):
    # This class is responsible for managing the chain. Stores transactions and has helper methods for
    # adding new blocks to the chain

    def __init__(self):
        # This is sort of like a constructor, and these are variables below
        self.chain = []
...
def register_nodes():
    ...
    for node in nodes:  # this is a for each loop in python
